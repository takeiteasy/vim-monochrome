...
let s:palette.black = [234, '#111111']
...
let s:palette.white = [255, '#FFFFFF']
...
call s:hi('Constant', s:palette.main, [], 'bold')
call s:hi('String', s:palette.main, [], '')
call s:hi('Number', s:palette.main, [], '')

call s:hi('Identifier', s:palette.white, [], 'none')
call s:hi('Function', s:palette.white, [], 'bold')

call s:hi('Statement', s:palette.white, [], 'bold')
call s:hi('Operator', s:palette.white, [], 'none')
call s:hi('Keyword', s:palette.white, [], '')
...
call s:hi('Todo', s:palette.white, s:palette.main, 'bold')
if has("gui_running")
...
call s:hi('FoldColumn', s:palette.gray07, s:palette.blackest, 'none')
call s:hi('CursorLine', [], s:palette.blackest, 'none')
call s:hi('CursorLineNr', s:palette.gray14, s:palette.blackest, 'none')
...
call s:hi('MatchParen', s:palette.white, s:palette.main, '')

call s:hi('Cursor', s:palette.main, s:palette.gray12, '')
...
call s:hi('StatusLineNC', s:palette.gray04, s:palette.black, 'none')
...
call s:hi('GitGutterAdd', s:palette.green, s:palette.blackest, '')
call s:hi('GitGutterChange', s:palette.brown, s:palette.blackest, '')
call s:hi('GitGutterDelete', s:palette.red, s:palette.blackest, '')
